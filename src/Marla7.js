  ...
  return (
    <>
      ...
      <div className="marla3-container">
        ...
        <p>
          You can run up to 3000W of load appliances on a 3KW solar system. An <a href="https://solarpanelpricepakistan.pk/appliance-load-calculator/" target="_blank" rel="noopener noreferrer">Appliance Load Calculator</a> can be used for calculating the total load of home appliances you want to run on the 3kW solar system. The most common and necessary devices for a home that you can run on a 3KW solar system are shown below.
        </p>
