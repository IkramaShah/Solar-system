  ...
  return (
    <>
      ...
      <div className="marla3-container">
        ...
        <p>
          You can run up to 1000W of load appliances on a 1KW solar system. An <a href="https://solarpanelpricepakistan.pk/appliance-load-calculator/" target="_blank" rel="noopener noreferrer">Appliance Load Calculator</a> can be used for calculating the total load of home appliances you want to run on the 1kW solar system. The most common and necessary devices for a home that you can run on a 2KW solar system are shown below.
        </p>
